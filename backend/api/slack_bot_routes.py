...
def slack_events():
    ...
    try:
        ...
        if data.get('type') == 'event_callback':
            ...
            # DISABLED: Event processing was causing server blocking due to Python's GIL
            # The RAG pipeline and embeddings are CPU-intensive and block all other requests
            print(f"[SlackBot] Event processing DISABLED for performance - event: {event_subtype}", flush=True)
