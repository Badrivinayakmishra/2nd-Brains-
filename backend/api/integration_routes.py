...
def gmail_callback():
    ...
    try:
        ...
        try:
            ...
            # Users can manually sync from the Integrations page
            ...
            if is_first_connection:
                print(f"[Gmail Callback] First connection - user can manually sync")
...
def slack_callback():
    ...
    try:
        ...
        try:
            ...
            # Users can manually sync from the Integrations page
            if is_first_connection:
                print(f"[Slack Callback] First connection - user can manually sync")
...
def box_callback():
    ...
    try:
        ...
        try:
            ...
            # Auto-sync DISABLED - blocks server due to Python GIL
            if is_first_connection:
                print(f"[Box Callback] First connection - user can manually sync")
...
def github_callback():
    ...
    try:
        ...
        try:
            ...
            # Auto-sync DISABLED - blocks server due to Python GIL
            if is_first_connection:
                print(f"[GitHub Callback] First connection - user can manually sync")
...
def notion_callback():
    ...
    try:
        ...
        try:
            ...
            # Auto-sync DISABLED - blocks server due to Python GIL
            if is_first_connection:
                print(f"[Notion Callback] First connection - user can manually sync")
...
def gdrive_callback():
    ...
    try:
        ...
        try:
            ...
            if is_first_connection:
                # Auto-sync DISABLED - blocks server due to Python GIL
                print(f"[GDrive Callback] First connection - user can manually sync")
...
def pubmed_configure():
    ...
    try:
        ...
        try:
            ...
            # Auto-sync DISABLED - blocks server due to Python GIL
            if is_first_connection:
                print(f"[PubMed] First connection - user can manually sync")
...
def webscraper_configure():
    ...
    try:
        ...
        try:
            ...
            # Auto-sync DISABLED - blocks server due to Python GIL
            if is_first_connection:
                print(f"[WebScraper] First connection - user can manually sync")
...
# ============================================================================
# SYNC OPERATIONS - DISABLED
# Sync functionality has been temporarily disabled to prevent server blocking.
# All syncs block Python's GIL, causing the entire server to become unresponsive.
# ============================================================================
...
def sync_connector(connector_type: str):
    """
    DISABLED: Sync functionality is temporarily unavailable.
    This was causing server blocking due to Python's GIL.
    """
    return jsonify({
        "success": False,
        "error": "Sync functionality is temporarily disabled for performance optimization. Your integrations remain connected and data will sync when this feature is re-enabled."
    }), 503
...
def _run_connector_sync_DISABLED(
    connector_id: str,
    connector_type: str,
    since: datetime,
    tenant_id: str,
